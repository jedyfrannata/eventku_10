...
public class RegisterPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        username = (EditText)findViewById(R.id.edtText_usernameRegis);
        password = (EditText)findViewById(R.id.edtText_passwordRegis);
        passwordConf = (EditText)findViewById(R.id.edtText_passwordConfrimRegis);
